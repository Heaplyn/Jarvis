---
title: "NewIdeasCommandHandler - Technical Specification"
...
# NewIdeasCommandHandler - Technical Specification

> [!NOTE] Subsystem Architectural Blueprint & Developer Reference
> **Source File**: `Modules\Layer3\Handlers\Productivity\NewIdeasCommandHandler.cs`  
...
Handles Window Snap/Layouts, Macro chains, Network Speedtest/Ping, Folder Quick Jumps, Process Manager GUI, World Clock, and File Hash features.

`MacroItem` is an integral part of `04 - Layer 3 Command Handlers`. It enforces the Jarvis architectural invariant where lower layers provide isolated, crash-proof services to higher-level UI and command execution layers.

---

## ⚙️ Practical Real-World Workflow & Developer Use Cases
Executes core operational logic for `NewIdeasCommandHandler` within the `04 - Layer 3 Command Handlers` subsystem. It provides asynchronous processing, memory-safe data operations, and direct integration with the Jarvis desktop assistant.
...
| `LoadMacros` | `private static` | `List<MacroItem>` | `*none*` |
| `GetMacrosDirectory` | `private static` | `string` | `*none*` |
| `SaveMacro` | `private static` | `void` | `string name, string chain` |
| `ParseAndAddMacro` | `private static` | `void` | `string input` |
| `RunMacroChain` | `private static` | `void` | `string chain` |
| `ExecutePing` | `private static` | `void` | `string host` |
| `OpenFolder` | `private static` | `void` | `string path` |
| `ShowCityTime` | `private static` | `void` | `string city` |
| `CalculateFileHash` | `private static` | `void` | `string filePath` |
| `GetSystemQuote` | `private static` | `void` | `*none*` |

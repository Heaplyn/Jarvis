---
title: "DecompiledProjectOverlay - Technical Specification"
...
# DecompiledProjectOverlay - Technical Specification

> [!NOTE] Subsystem Architectural Blueprint & Developer Reference
> **Source File**: `Modules\Layer2\Dev\DisassemblerSuite\Ring2_UI\DecompiledProjectOverlay.cs`  
...
```mermaid
graph TD
    Sub["DecompiledProjectOverlay (class)"]
...
Editable "decompile to C" workbench. Loads a binary, runs the native decompiler
...
`DecompiledProjectOverlay` is an integral part of `07 - Reverse Engineering Suite`. It enforces the Jarvis architectural invariant where lower layers provide isolated, crash-proof services to higher-level UI and command execution layers.

---

## ⚙️ Practical Real-World Workflow & Developer Use Cases
Executes core operational logic for `DecompiledProjectOverlay` within the `07 - Reverse Engineering Suite` subsystem. It provides asynchronous processing, memory-safe data operations, and direct integration with the Jarvis desktop assistant.
...
| :--- | :--- | :--- | :--- |
| `ShowOverlay` | `public static` | `void` | `string? preloadPath = null` |
| `RefreshAiButton` | `private ` | `void` | `*none*` |
| `SetFile` | `private ` | `void` | `string path` |
| `BrowseFile` | `private ` | `void` | `*none*` |
| `SaveProject` | `private ` | `void` | `*none*` |
| `ShowToolStatus` | `private ` | `void` | `*none*` |
| `LaunchDbg` | `private ` | `void` | `*none*` |
| `Status` | `private ` | `void` | `string msg` |
...
sequenceDiagram
    ...
    participant Sub as DecompiledProjectOverlay

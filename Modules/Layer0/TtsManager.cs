...
namespace JarvisLauncher
{
    public class TtsManager : ITtsService
    {
        ...
        public static void SetRate(int r) => ((TtsManager)CoreRegistry.Tts).SetRateInternal(r);
        public static void SetVolume(int v) => ((TtsManager)CoreRegistry.Tts).SetVolumeInternal(v);
